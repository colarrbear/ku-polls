...
class QuestionModelTests(TestCase):
    ...
    def test_is_unpublished_question(self):
        """is_published() returns False when the pub_date is in the future."""
        time = timezone.now() + datetime.timedelta(days=1)
        future_question = Question(pub_date=time)
        self.assertFalse(future_question.is_published())

    def test_is_published_question(self):
        """is_published() returns True when the pub_date is in the past."""
    ...
    def test_can_vote_published_question(self):
        """can_vote() returns True when the question is published."""
        time = timezone.now() - datetime.timedelta(days=3)
    ...
    def test_can_vote_published_question_after_end_date(self):
        """can_vote() returns False when the end date has passed."""
    ...
    def test_can_vote_unpublished_question(self):
        """can_vote() returns False when the question is not published."""
    ...
    def test_can_vote_default_published_date(self):
        """can_vote() returns True for a question with the default pub_date."""
...
class QuestionDetailViewTests(TestCase):
    """A test for future/past question"""
